...
namespace Magetrend\GiftCard\Block\Adminhtml\GiftCardSet\Grid\Column\Renderer;

class Value extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text
{
    /**
