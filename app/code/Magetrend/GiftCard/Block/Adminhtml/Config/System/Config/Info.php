 ...
 */
namespace Magetrend\GiftCard\Block\Adminhtml\Config\System\Config;
...
{
    const MODULE_NAMESPACE = 'Magetrend_GiftCard';

    const CONFIG_NAMESPACE = 'giftcard';

    const XML_PATH_GENERAL = 'giftcard/general/is_active';
