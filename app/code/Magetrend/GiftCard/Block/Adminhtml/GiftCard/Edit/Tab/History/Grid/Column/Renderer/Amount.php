...
class Amount extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text
{
    /**
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $formatedValue = $this->priceCurrencyInterface->format(
            $value,
            false,
        ...
        return '<span style="color: '.$color.'">'.$plusMinus.$formatedValue.'</span>';
    }
}
