...
class Edit extends \Magetrend\GiftCard\Controller\Adminhtml\GiftCardSet
{
    /**
     * Init actions
     *
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Magetrend_GiftCard::giftcardset');
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(
            $id ? __('Edit Gift Card Set') : __('New Gift Card Set'),
            $id ? __('Edit Gift Card Set') : __('New Gift Card Set')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Gift Card'));
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? __('Edit Gift Card Set #').$id : __('New Gift Card Set'));
